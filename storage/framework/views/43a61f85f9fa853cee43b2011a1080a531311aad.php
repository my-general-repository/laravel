...
<span class="input-group-btn">
  <button type='submit' name='search' id='search-btn' class="btn btn-flat"><i class="fa fa-search"></i></button>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="#"><span>Продукти</span></a></li>
            <li><a href="#"><span>Марки</span></a></li>
            <li><a href="#"><span>Видове</span></a></li>
            <li class="treeview">
                <a href="#"><span>Региони</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="#">Държава</a></li>
            ...
            <li><a href="#"><span>Главна снимка</span></a></li>
            <li><a href="#"><span>Галерия</span></a></li>
        </ul>
    </section>
</aside>